...
class HtmlTagIdentifiers:
    # Id
    USERNAME_FORM = 'f_login'
    PASSWORD_FORM = 'f_senha'
    MAIN_FRAME = 'main'
    LEFT_MENU_REPORT_BUTTON_ID = 'liModulo_32'
    LEFT_MENU_HIDDEN_ACCESS_BUTTON_ID = "[data-nometela='Acessar']"
    CSV_EXPORT_BUTTON_ID = "(//li[@id='fm-tab-export-csv']/a)"
    MAIN_FRAME = 'main'
